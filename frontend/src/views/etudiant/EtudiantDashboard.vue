...
const breadcrumbs = computed(() => {
  ...
  if (path === "/etudiant") return ["Accueil", "Tableau de bord"];
  if (path.includes("/schedule")) return ["Accueil", "Calendrier"];
  if (path.includes("/subjects")) return ["Accueil", "Matières"];
  if (path.includes("/profile")) return ["Accueil", "Profil"];
  if (path.includes("/settings")) return ["Accueil", "Paramètres"];
  if (path.includes("/notifications")) return ["Accueil", "Notifications"];
  ...
  <div
    ...
    <aside
      ...
      <div class="flex flex-col gap-2 px-4 mt-auto">
        <!-- Settings -->
        <RouterLink to="/etudiant/settings" class="relative nav-item group" active-class="is-active">
          <div class="icon-wrapper">
            <div class="glow-effect"></div>
      ...
      <header class="flex items-center justify-between h-20 px-8 shrink-0">
        ...
        <div class="flex items-center gap-6">
          <div class="flex items-center gap-2 text-sm">
            ...
            <span v-for="(crumb, i) in breadcrumbs" :key="i" class="flex items-center">
              ...
              <span v-if="i < breadcrumbs.length - 1" class="mx-2 text-gray-600">
                /
              </span>
            </span>
          </div>
        ...
        <div class="flex items-center gap-4">
          ...
          <RouterLink to="/etudiant/notifications"
            ...
            <div class="absolute top-2.5 right-2.5 w-2 h-2 bg-red-500 rounded-full border-2 border-gt-card"></div>
