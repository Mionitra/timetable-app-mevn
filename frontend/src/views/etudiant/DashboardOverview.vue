    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2 space-y-4">
         ...
         <div v-if="todayClasses.length > 0" class="bg-gt-card border border-white/5 rounded-3xl p-6">
            ...
            <p v-if="todayClasses[0].description" class="text-sm text-gray-400 mb-6">Description : {{ todayClasses[0].description }}</p>
         ...
         <div v-if="todayClasses.length > 1" class="bg-gt-card border border-white/5 rounded-3xl p-6">
            ...
            <p v-if="todayClasses[1].description" class="text-sm text-gray-400 mb-6">Description : {{ todayClasses[1].description }}</p>
